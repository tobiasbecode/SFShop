...
import { Renderer2, ElementRef, Directive, Component, ViewChild, HostBinding, HostListener, Input, EventEmitter, Output, ContentChild, ChangeDetectorRef, forwardRef, NgModule } from '@angular/core';
...
var SliderElementDirective = /** @class */ (function (_super) {
    __extends(SliderElementDirective, _super);
...
var SliderComponent = /** @class */ (function () {
    ...
    SliderComponent.prototype.subscribeResizeObserver = function () {
        ...
        if (CompatibilityHelper.isResizeObserverAvailable()) {
            this.resizeObserver = new ResizeObserver(function () { return _this.calcViewDimensions(); });
    ...
    SliderComponent.prototype.manageElementsStyle = function () {
        ...
        this.alwaysHide(this.floorLabelElement, this.viewOptions.showTicksValues || this.viewOptions.hideLimitLabels);
        this.alwaysHide(this.ceilLabelElement, this.viewOptions.showTicksValues || this.viewOptions.hideLimitLabels);
        var hideLabelsForTicks = this.viewOptions.showTicksValues && !this.intermediateTicks;
        this.alwaysHide(this.minHandleLabelElement, hideLabelsForTicks || this.viewOptions.hidePointerLabels);
        this.alwaysHide(this.maxHandleLabelElement, hideLabelsForTicks || !this.range || this.viewOptions.hidePointerLabels);
        this.alwaysHide(this.combinedLabelElement, hideLabelsForTicks || !this.range || this.viewOptions.hidePointerLabels);
        this.alwaysHide(this.selectionBarElement, !this.range && !this.viewOptions.showSelectionBar);
        this.alwaysHide(this.leftOuterSelectionBarElement, !this.range || !this.viewOptions.showOuterSelectionBars);
        this.alwaysHide(this.rightOuterSelectionBarElement, !this.range || !this.viewOptions.showOuterSelectionBars);
    ...
    SliderComponent.prototype.updateLowHandle = function (newPos) {
        ...
        this.setPosition(this.minHandleLabelElement, this.getHandleLabelPos(PointerType.Min, newPos));
    ...
    SliderComponent.prototype.updateHighHandle = function (newPos) {
        ...
        this.setPosition(this.maxHandleLabelElement, this.getHandleLabelPos(PointerType.Max, newPos));
        if (this.viewOptions.getPointerColor) {
    ...
    SliderComponent.prototype.shFloorCeil = function () {
        ...
        var flHidden = false;
        var clHidden = false;
        var isMinLabAtFloor = this.isLabelBelowFloorLab(this.minHandleLabelElement);
        var isMinLabAtCeil = this.isLabelAboveCeilLab(this.minHandleLabelElement);
        var isMaxLabAtCeil = this.isLabelAboveCeilLab(this.maxHandleLabelElement);
        var isCmbLabAtFloor = this.isLabelBelowFloorLab(this.combinedLabelElement);
        var isCmbLabAtCeil = this.isLabelAboveCeilLab(this.combinedLabelElement);
        if (isMinLabAtFloor) {
            flHidden = true;
    ...
    SliderComponent.prototype.updateSelectionBar = function () {
        ...
        if (this.range && this.viewOptions.showOuterSelectionBars) {
            if (this.viewOptions.rightToLeft) {
                ...
                this.calculateElementDimension(this.fullBarElement);
                this.setDimension(this.leftOuterSelectionBarElement, this.fullBarElement.dimension - (position + dimension));
                ...
                this.calculateElementDimension(this.fullBarElement);
                this.setDimension(this.rightOuterSelectionBarElement, this.fullBarElement.dimension - (position + dimension));
        ...
        if (isLabelOverlap) {
            ...
            var pos = this.viewOptions.boundPointerLabels
                ? Math.min(Math.max(this.selectionBarElement.position +
                    ...
                    this.combinedLabelElement.dimension / 2, 0), this.barDimension - this.combinedLabelElement.dimension)
    ...
    SliderComponent.prototype.bindEvents = function () {
        ...
        if (!this.viewOptions.onlyBindHandles) {
            this.selectionBarElement.on('mousedown', function (event) { return _this.onBarStart(draggableRange, event, true, true, true); });
        }
        if (this.viewOptions.draggableRangeOnly) {
            this.minHandleElement.on('mousedown', function (event) { return _this.onBarStart(draggableRange, event, true, true); });
            this.maxHandleElement.on('mousedown', function (event) { return _this.onBarStart(draggableRange, event, true, true); });
        }
        else {
        ...
        if (!this.viewOptions.onlyBindHandles) {
            this.selectionBarElement.onPassive('touchstart', function (event) { return _this.onBarStart(draggableRange, event, true, true); });
        }
        if (this.viewOptions.draggableRangeOnly) {
            this.minHandleElement.onPassive('touchstart', function (event) { return _this.onBarStart(draggableRange, event, true, true); });
            this.maxHandleElement.onPassive('touchstart', function (event) { return _this.onBarStart(draggableRange, event, true, true); });
        }
        else {
    ...
    SliderComponent.prototype.onBarStart = function (draggableRange, event, bindMove, bindEnd, simulateImmediateMove, simulateImmediateEnd) {
        if (draggableRange) {
...
SliderComponent.propDecorators = {
    ...
    "minHandleElement": [{ type: ViewChild, args: ['minHandle', { read: SliderElementDirective },] },],
    "maxHandleElement": [{ type: ViewChild, args: ['maxHandle', { read: SliderElementDirective },] },],
...
export { Ng5SliderModule, ChangeContext, PointerType, LabelType, Options, JqLiteWrapper as ɵc, SliderElementDirective as ɵb, SliderLabelDirective as ɵd, SliderComponent as ɵa, TooltipWrapperComponent as ɵe };
